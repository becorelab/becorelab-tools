...
SHIP={"카페24":1284000,"스마트스토어":1578000,"지마켓":37713,"라이플로우":537000,"PG컴퍼니":57000,"두버":153000,"에드가":6000}  # 카페24 취소주문 배송 42,000 제외 (7/14)
# 광고비 (2026-07-15 확정 v2): 로켓 14,263,512 / 메타 13,030,612 / 스스 = 쏘핑수수료 8,695,988(골라담기 포함 정정) + 애드부스트 1,292,283 + 검색광고 1,447,286(API·마케팅파일 실측, 총소진 기준)
AD={"카페24":13030612,"쿠팡(로켓배송)":14263512,"쿠팡(로켓그로스)":3600061,"스마트스토어":8695988+1292283+1447286,"11번가":157409}
...
for c in [2,3,4,6]: m(ws4.cell(row=r,column=c))
pc(ws4.cell(row=r,column=5)); pc(ws4.cell(row=r,column=7))
ws4.cell(row=r+2,column=1,value='※ 스스 광고비 = 쏘핑 공구 수수료 8,695,988(공구매출 31,057,100×28%, 골라담기 포함 7/15 정정) + 애드부스트 1,292,283 + 검색광고 1,447,286(총소진 실측). 11번가 = 후불광고비. 로켓 14,263,512 = 대표님 확정.')
