...
- [ ] **인스타 공구 최초 로그인** — `cd ~/ClaudeAITeam/marketing/instagram_gonggu && venv/bin/python3 login_manual.py` 실행 후 브라우저에서 로그인 (2026-04-25)
...
## 카페 바이럴 v2.1 — ⏸️ 잠정 보류 (2026-04-25 대표님 지시)
