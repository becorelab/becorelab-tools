...
def api_daily_report_obsidian():
    ...
    try:
        ...
        obs_dir = os.path.expanduser("~/Documents/비코어랩/01. Becorelab AI Agent Team/2️⃣ Areas/📊 Operations/📊 Sales Report/일일")
...
# ── 옵시디언 재고 일일 보고서 생성 ──
OBSIDIAN_STOCK_DIR = os.path.expanduser("~/Documents/비코어랩/01. Becorelab AI Agent Team/2️⃣ Areas/📊 Operations/📦 Stock & Order")
