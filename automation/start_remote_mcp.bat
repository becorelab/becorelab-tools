...
cd /d C:\Users\User\ClaudeAITeam\mcp-server
...
start "becorelab_remote_mcp" /B ".venv\Scripts\python.exe" server_remote.py > C:\Users\User\ClaudeAITeam\data\remote_mcp.log 2>&1
